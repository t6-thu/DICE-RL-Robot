...
export YAM_HANOI_EXPERT_NPZ="${YAM_HANOI_EXPERT_NPZ:-$RECOVERED_DATA_DIR/train.npz}"
export YAM_HANOI_NORM_NPZ="${YAM_HANOI_NORM_NPZ:-$RECOVERED_DATA_DIR/normalization.npz}"
...
export YAM_HANOI_RUN_NAME="${YAM_HANOI_RUN_NAME:-hanoi_hire_sparse_online_success_recovered_success_v1}"
