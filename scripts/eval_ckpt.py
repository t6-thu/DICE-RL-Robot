...
def main():
    ...
    # Keep eval aligned with the task launcher rather than silently falling
    # back to the shared bottle hardware defaults.  Hanoi sets
    # YAM_POLICY_CAMERA_ORDER=wrist_base (rgb_0=wrist, rgb_1=base).
