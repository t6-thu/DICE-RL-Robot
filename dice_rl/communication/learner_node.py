...
class Learner:
    def __init__(self,
        ...
        print("[Learner] Initializing Learner... network_server_endpoint:", network_server_endpoint)
        ...
        self.transitions_server_endpoint = transitions_server_endpoint
    ...
    def reconnect_transitions_client(self):
        """Recreate the transitions client to handle env_runner restarts."""
        print("[Learner] Reconnecting transitions client...")
        self.transitions_client = rmq.RMQClient(
            client_name="transitions_client", server_endpoint=self.transitions_server_endpoint
        )
        print("[Learner] transitions_client reconnected")
    ...
    def receive_transitions(self):
        ...
        retrieved_data, timestamp = self.transitions_client.pop_data(topic=self.transitions_topic, order="earliest", n=1)
