            ...
            for local_epoch_idx in range(cfg.training.num_epochs):
                ...
                with tqdm.tqdm(
                    ...
                    for batch_idx, batch in enumerate(tepoch):
                        ...
                        #         model_unwrapped.model_sparse.parameters(),
                ...
                def log_action_mse(step_log, category, pred_action, gt_action):
                    ...
                    if pred_naction_sparse.shape[-1] == 10:
                        step_log[f"{category}_gripper_naction_mse_error"] = (
                            torch.nn.functional.mse_loss(
                                pred_naction_sparse[..., 9:10], gt_naction_sparse[..., 9:10]
                            )
                        )
                    if pred_naction_sparse.shape[-1] >= 18:
